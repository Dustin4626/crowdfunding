...
<script type="text/javascript">
	...
	function initPagination() {
		...
		// 获取总记录数
		var totalRecord = ${requestScope.pageInfo.totalElements};
		...
		var properties = {
			...
			items_per_page: ${requestScope.pageInfo.pageable.pageSize},	// 每页要显示的数据的数量
			current_page: ${requestScope.pageInfo.pageable.pageNumber},	// Pagination内部使用pageIndex来管理页码，pageIndex从0开始，pageNum从1开始，所以要减一
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="admin/page.html" method="post" class="form-inline"
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								...
								<tbody>
									<c:if test="${empty requestScope.pageInfo.content }">
										<tr>
											<td colspan="6" align="center">抱歉！没有查询到您要的数据！</td>
										</tr>
									</c:if>
									<c:if test="${!empty requestScope.pageInfo.content }">
										<c:forEach items="${requestScope.pageInfo.content }"
											...
											<tr>
												...
												<td>${admin.email }</td>
												<td>
													<a href="assign/to/assign/role/page.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageable.pageNumber }&keyword=${param.keyword }" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></a>
