...
function fillTableBody(pageInfo) {
	...
	// 判断pageInfo对象是否有效
	if(pageInfo == null || pageInfo == undefined || pageInfo.content == null || pageInfo.content.length == 0) {
...
function generateNavigator(pageInfo) {
	...
	var properties = {
		...
		"current_page": pageInfo.pageable.pageNumber,
		"prev_text": "上一页",
		"next_text": "下一页"
	}
