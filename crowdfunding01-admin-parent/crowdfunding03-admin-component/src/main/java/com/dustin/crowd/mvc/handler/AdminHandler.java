...
public class AdminHandler {
	...
	public String toEditPage(@RequestParam("adminId") Long adminId, ModelMap modelMap) {
	...
	public String update(Admin admin, @RequestParam("pageNum") Long pageNum, @RequestParam("keyword") String keyword) {
