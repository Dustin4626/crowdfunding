...
public class RoleHandler {
	...
	public ResultEntity<String> removeByRoleIdAarry(@RequestBody List<Long> roleIdList) {
	...
	public ResultEntity<Page<Role>> getPageInfo(
		...
		// 调用Service方法获取分页数据
		Page<Role> pageInfo = roleService.getPageInfo(pageNum, pageSize, keyword);
